 ...
 *    incluindo o próprio aplicativo na contagem.
 *  @param argv  Valores passados nos argumentos, onde o nome do próprio 
 *    aplicativo é inserido como sendo o primeiro argumento.
 *
 *  @return Valor padrão de retorno da função @c main pelo padrão ANSI-C.
 *  @retval 0  Indica sucesso na execução do software.
 ****************************************************************************/
int main(void)
/****************************************************************************/
{
