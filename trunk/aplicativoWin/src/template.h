 ...
 *
 *  Substitua este texto pela descrição completa deste módulo como um todo.
 ...
 *
 *  @note
 *  As variáveis exportadas devem possuir a primeira letra de cada palavra em
 *  maiúsculo e as demais letras em minúsculo.
 *
 *  @attention
 *  A palavra reservada @b extern deve ser sempre utilizada para não conflitar
 *  com a declaração da mesma variável realizada no arquivo ".c" do mesmo
 *  módulo.
 */
 ...
 *
 *  @note
 *  Vários recursos de documentação podem ser utilizados. Consulte a
 *  documentação do Doxygen para mais informações.
 *
 ...
 *  função que será visível para os outros módulos do projeto.
 *
 ...
 *
 *  @note
 *  As funções exportadas devem possuir a primeira letra de cada palavra em
 *  maiúsculo e as demais letras em minúsculo.
 ****************************************************************************/
