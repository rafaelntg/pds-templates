 ...
 *  - Os padrões de comentário que começam com BARRA-ASTERISCO-ASTERISCO, como este, devem ser compilados com 
 *    a ferramenta Doxygen (comando: "doxygen.exe doxygen.cfg").
 ...
 *
 *  Esta função simplesmente exemplifica como codificar e documentar uma função que será visível para os 
