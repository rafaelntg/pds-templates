 ...
 *
 *  @note
 *  Apesar dessa variável não ser visível para outros módulos, ela não pode
 *  possuir o mesmo nome que qualquer outro identificador deste projeto, como
 ...
 *
 *  @note
 *  Diferentemente das variáveis globais exportadas, as variáveis globais não
 *  exportadas devem ser nomeadas com todas as letras em minúsculo, exceto a
 ...
 *
 *  @note
 *  Diferentemente das funções exportadas, as funções locais devem ser
 *  nomeadas com todas as letras em minúsculo, exceto a primeira letra de cada
 *  palavra a partir da segunda palavra.
 ****************************************************************************/
 void funcaoLocalTemplate(void)
/****************************************************************************/
{
 ...
 *
 *  Esta função simplesmente exemplifica como codificar e documentar uma
 *  função local, a qual somente será visível para este módulo.
 *  Geralmente as funções locais são funções auxiliares utilizadas pelas
